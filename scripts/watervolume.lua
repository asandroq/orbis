...
wv:setViscosity(0.0)
wv:addSource(Point(1.5, 1.5, 1.5), Vector(0.0, 0.5, 0.0), 0.1)
wv:addSource(Point(2.5, 1.5, 1.5), Vector(0.0, 0.5, 0.0), 0.1)
wv:addSource(Point(3.5, 1.5, 1.5), Vector(0.0, 0.5, 0.0), 0.1)
