 ...
 *
 * $Id: matrix.hpp,v 1.1 2003/07/18 03:11:49 asandro Exp $
 */

#ifndef __ORBIS_MATRIX_HPP__
#define __ORBIS_MATRIX_HPP__
...
/*!
 * \brief This class represents a simple 4x4 matrix.
 */
class Matrix {
public:
	/*!
