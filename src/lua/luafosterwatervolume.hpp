...
#ifndef __ORBIS_LUAFOSTERWATERVOLUME_HPP__
#define __ORBIS_LUAFOSTERWATERVOLUME_HPP__
...
public:
	 ...
	 */
	static Orbis::Drawable::FosterWaterVolume* checkInstance(lua_State* L, int index);
...
#endif //__ORBIS_LUAFOSTERWATERVOLUME_HPP__
