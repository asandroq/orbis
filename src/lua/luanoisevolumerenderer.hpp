...
#ifndef __ORBIS_LUANOISEVOLUMERENDERER_HPP__
#define __ORBIS_LUANOISEVOLUMERENDERER_HPP__
...
/*!
 * \brief This class exports the NoiseVolumeRenderer
 * to the Lua interpreter.
 */
class LuaNoiseVolumeRenderer {
public:
	/*!
	 ...
	 */
	static Orbis::Drawable::NoiseVolumeRenderer* checkInstance(lua_State* L, int index);
...
#endif // __ORBIS_LUANOISEVOLUMERENDERER_HPP__
