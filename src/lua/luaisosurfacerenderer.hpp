...
#ifndef __ORBIS_LUAISOSURFACERENDERER_HPP__
#define __ORBIS_LUAISOSURFACERENDERER_HPP__
...
/*!
 * \brief This class exports the IsoSurfaceWaterVolumeRenderer
 * to the Lua interpreter.
 */
class LuaIsoSurfaceRenderer {
public:
	/*!
	...
	/*!
	 * \brief checks if element at given index is of this class.
	 * \param L The Lua state.
	 * \param index Stack index of element to be checked.
	 * \return A pointer to the object or 0 if element is not of this type
	 */
	static Orbis::Drawable::IsoSurfaceWaterVolumeRenderer* checkInstance(lua_State* L, int index);
...
private:
	...
	/*!
	 * \brief Collects the memory of an instance of this class.
	 * \param L The Lua state.
	 * \return The number of results pushed onto the stack.
	 */
...
#endif // __ORBIS_LUAISOSURFACERENDERER_HPP__
